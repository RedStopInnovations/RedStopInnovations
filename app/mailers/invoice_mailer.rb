class InvoiceMailer < ApplicationMailer
  ...
  def invoice_mail_new(invoice, recipient_email, email_subject, email_content, options = {})
    ...
    template.attachments.each do |template_atm|
      attachments[template_atm.attachment_file_name] = Paperclip.io_adapters.for(template_atm.attachment).read
    end
    ...
    subject = email_subject.presence || "Invoice ##{invoice.invoice_number} - #{business.name}"
