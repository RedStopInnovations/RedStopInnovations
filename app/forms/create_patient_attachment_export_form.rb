class CreatePatientAttachmentExportForm < BaseForm
  ...
  attribute :patient_ids, Array[Integer]

  validates_date :start_date, on_or_before: :end_date, allow_nil: true, allow_blank: true
