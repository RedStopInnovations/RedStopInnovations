module ClinikoImporting
  module Mapper
    module TreatmentTemplate
      # @param cliniko_patient ClinikoApi::Resource::TreatmentTemplate
      def self.build(cliniko_treatment_template)
        local_attrs = {}
        {
          name: :name,
          ...
          local_attrs[local_field] = cliniko_treatment_template.send cliniko_field
        end

        # Map sections
        local_sections = []
        cliniko_treatment_template.content.sections.each do |cliniko_section|
          local_section = {
        ...
        local_attrs[:template_sections] = local_sections
